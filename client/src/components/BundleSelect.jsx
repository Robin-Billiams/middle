...
const BundleSelect = (props) => (
  <div className="frequent-products-select">
        ...
        <span className="frequent-products-select-option-checkbox" ><input type="checkbox" id="product0" name="product0" value="product0" checked readOnly/></span>
        ...
        <div className="frequent-products-select-option">
        <span className="frequent-products-select-option-checkbox" ><input type="checkbox" id="product1" name="product1" value="product1" defaultChecked onChange={(e) => props.productChecked(1)}/></span>
        ...
        <div className="frequent-products-select-option">
        <span className="frequent-products-select-option-checkbox" ><input type="checkbox" id="product2" name="product2" value="product2" defaultChecked onChange={(e) => props.productChecked(2)}/></span>
        ...
        <div className="frequent-products-select-option">
        <span className="frequent-products-select-option-checkbox" ><input type="checkbox" id="product3" name="product3" value="product3" defaultChecked onChange={(e) => props.productChecked(3)}/></span>
